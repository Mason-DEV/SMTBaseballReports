								...
								<Row>
									<Col>
										...
										<FormGroup>
											<Label htmlFor="date">Date</Label>
											 <Input id="date" type="date" name="date" onChange={e => this.change(e)}  required /*defaultValue={this.currentDate()}*/></Input> 
										</FormGroup>
										<FormGroup>
										...
										<FormGroup>
											...
											<Input id="first-pitch" type="time" name="firstPitch" onChange={e => this.change(e)} required></Input>
										</FormGroup>
										<FormGroup>
									...
									<Col>
										...
										<FormGroup>
											...
											{this.props.permission === "support" ? (
												<Input required type="textarea" onChange={e => this.change(e)} name="t1Notes" id="t1Notes" ></Input>
											) : (
